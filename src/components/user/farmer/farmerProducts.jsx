...
import FarmProdBuy from './farmerProdBuy';
import FarmProdSell from './farmerProdSell';
...
export default function FarmerProducts() {
  ...
  const [visible,setVisible]=React.useState('buy')
  ...
  return (
        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            >
                ...
                <MenuItem  onClick={'/user/farmer/product'}>
    ...
    >
      ...
      {/* {if(orderData.orderstatus){
        <div style={(!orderData.orderstatus)?{display:'none'}:{display:'flex'}}>
  ...
  <Box sx={{ width: 500 }}
      ...
      >
        <BottomNavigationAction  label="buy"  onClick={()=>{setVisible('buy')}}  />
